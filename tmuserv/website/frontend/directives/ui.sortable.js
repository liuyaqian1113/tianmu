            ...
            return {
                ...
                link: function (scope, element, attrs, ngModel) {
                        ...
                        if (oldVal) {
                            ...
                            angular.forEach(oldVal, function (oldValue, key) {
                                if (!newVal || !(key in newVal)) {
                                    ...
                                    if (!defaultOptions) {
                                        defaultOptions = angular.element.ui.sortable()
                                            .options;
                                    }
                    ...
                    function isFloating(item) {
                        return (/left|right/)
                            .test(item.css('float')) || (/inline|table-cell/)
                    ...
                    function wireUp() {
                        ...
                        callbacks.stop = function (e, ui) {
                            ...
                            } else if (!wasMoved && !angular.equals(element.contents()
                                    .toArray(), savedNodes.toArray())) {
